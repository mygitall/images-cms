const copy = {
  en: {
    ...
    openCaseAria: (id, title) => `Open case ${id}: ${title}`,
    modelsLabel: 'Models: ',
    uploadBtn: 'Upload',
    viewFullImage: 'View full image',
    closeDialog: 'Close',
    referenceModeTitle: 'Reference image mode',
    noReferenceImage: 'Please upload at least one reference image',
    ...
    apiBusy: '● Busy',
    apiTimeout: '● Timeout',
    apiInvalid: '● Invalid Key',
    historyTotal: (n) => `${n} images`,
    generatingTimer: (s) => `Generating... ${s}s`,
  ...
  ko: {
    ...
    openCaseAria: (id, title) => `케이스 열기 ${id}: ${title}`,
    modelsLabel: '모델: ',
    uploadBtn: '업로드',
    viewFullImage: '원본 보기',
    closeDialog: '닫기',
    referenceModeTitle: '참조 이미지 모드',
    noReferenceImage: '최소 1장의 참조 이미지를 업로드하세요',
    fileTooLarge: '이미지 크기는 10MB를 초과할 수 없습니다',
    fileReadFailed: '파일 읽기 실패',
    apiConfigLabel: 'API 설정',
    newApiLabel: 'API 추가',
    editPrefix: '편집 ',
    nameLabel: '이름',
    apiOk: '● 정상',
    ...
    apiTimeout: '● 시간 초과',
    apiInvalid: '● 키 무효',
    historyTotal: (n) => `총 ${n}장`,
    generatingTimer: (s) => `생성 중... ${s}초`,
  ...
  zh: {
    ...
    openCaseAria: (id, title) => `打开案例 ${id}: ${title}`,
    modelsLabel: '模型：',
    uploadBtn: '上传',
    viewFullImage: '查看原图',
    closeDialog: '关闭',
    referenceModeTitle: '参考图模式',
    noReferenceImage: '请至少上传一张参考图',
    ...
    apiTimeout: '● 超时',
    apiInvalid: '● Key 无效',
    historyTotal: (n) => `共 ${n} 张`,
    generatingTimer: (s) => `生成中... ${s}s`,
